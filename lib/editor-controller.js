...
export default class EditorController {
  ...
  isActive() {
    const pos = this.editorIntf.getCursorPosition();
    return !this.editor.hasMultipleCursors() && this.editorIntf.acceptsTableEdit(pos.row);
  }
